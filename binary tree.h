...
// 开	启用AVL平衡二叉树	注意:开启后不得调用DeleteNodeOfBinaryTree函数
// 关	禁用AVL平衡二叉树
// #define AVL

// 开	以文本文件输入输出		CreateBinaryTree函数中的参数FileName不得为NULL
// 关	以二进制文件输入输出	CreateBinaryTree函数中的参数FileName不得为NULL
#define READABLE

// 开	开启日志模式 以文本文件形式自动输出程序中的堆栈及队列的所有操作 必须启用READABLE才有效
// 关	关闭日志模式
#define LOG
...
// 入口参数Max:			二叉树最大结点数
// 入口参数FileName:	输入输出链表数据的文件名 若为NULL则无文件输入输出功能
